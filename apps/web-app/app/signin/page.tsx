  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute top-40 left-40 w-60 h-60 bg-green-400 rounded-full mix-blend-multiply filter blur-xl opacity-20 animate-pulse animation-delay-4000"></div>
      </div>
      ...
      <div className="relative z-10 flex min-h-screen">
        ...
        <div className="hidden lg:flex lg:w-1/2 xl:w-3/5 flex-col justify-center p-12 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white relative">
          ...
          <div className="absolute bottom-0 right-0 w-64 h-64 opacity-10">
            <div className="w-full h-full bg-gradient-to-tl from-blue-500 to-purple-600 rounded-full"></div>
          </div>
        </div>
              ...
              <div className="space-y-4">
                {loginLoading ? (
                  ...
                  <Button
                    ...
                    className="w-full flex items-center justify-center gap-3 bg-gradient-to-r from-slate-800 to-slate-900 hover:from-slate-900 hover:to-black text-white py-4 rounded-xl transition-all duration-200 transform hover:scale-105 shadow-lg"
                  >
